...
The framework demonstrates improved performance compared to classical ML and baseline quantum ML models.
Dataset
...
Dataset Description
•	Contains EEG recordings segmented into time-series samples
•	Originally consists of 5 classes
•	Converted into binary classification:
o	Seizure (Class 1)
o	Non-Seizure (Classes 2–5)
Preprocessing Steps
...
2. Quantum Hilbert-Space Feature Expansion
...
2.	Run classical ML baseline notebook.
3.	Run QML baseline notebook.
4.	Run the proposed hybrid model notebook.

Computational Consideration
Quantum feature expansion uses statevector simulation with exponential complexity:
2¹² = 4096-dimensional Hilbert space
